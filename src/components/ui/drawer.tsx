...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Overlay ref={ref} className={cn("absolute inset-0 z-[140] bg-black/80", className)} {...props} />
));
  ...
  return (
    <DrawerPortal container={container}>
      ...
      <DrawerPrimitive.Content
        ref={ref}
        className={cn(
          "absolute inset-x-0 bottom-0 z-[150] mt-24 flex h-auto flex-col rounded-t-2xl border bg-background",
          className,
        )}
        {...props}
      >
