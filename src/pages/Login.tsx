...
import { Shield, Lock, Wallet, CreditCard, TrendingUp, Sparkles, X, Loader2, ArrowLeft, Mail, CheckCircle2, Phone, Clock } from 'lucide-react';
      ...
      <div className="flex gap-3 mb-6">
        <Button
          ...
          className={cn(
            ...
            lastLogin === 'apple' && "ring-1 ring-primary/30"
          )}
        ...
        >
          {loadingProvider === 'apple' ? (
            ...
            <>
              ...
              {lastLogin === 'apple' && (
                <Clock className="w-3 h-3 text-primary absolute top-1.5 right-1.5" />
              )}
            </>
          )}
        </Button>
        <Button
          ...
          className={cn(
            "flex-1 h-14 relative",
            lastLogin === 'google' && "ring-1 ring-primary/30"
          )}
