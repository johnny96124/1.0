        ...
        <AnimatePresence mode="wait">
          {step === 'method' && (
            <MethodSelectionStep
              ...
              onCloudUnavailable={() => navigate('/cloud-recovery-unavailable')}
            />
          )}
          {step === 'file_select' && (
            <FileSelectStep
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3 flex-1">
        {/* Cloud Recovery - always show, but with different states */}
        <motion.button
        ...
        >
          <div className="flex items-start gap-3">
            <div className={cn(
              ...
              hasCloudBackup ? "bg-primary/10" : "bg-muted"
            )}>
              <Cloud className={cn(
                "w-5 h-5",
                hasCloudBackup ? "text-primary" : "text-muted-foreground"
              )} />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className={cn(
                  "font-medium",
                  hasCloudBackup ? "text-foreground" : "text-muted-foreground"
                )}>云端恢复</span>
                {hasCloudBackup && (
